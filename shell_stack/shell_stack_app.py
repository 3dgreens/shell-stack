...
class ShellStackApp(App):
    ...
    def __init__(self, ssh_config_path: Path | None = None, refresh_interval: int | None = None) -> None:
        super().__init__()
    ...
    def compose(self) -> ComposeResult:
        yield Header()
        yield HostsTable(self, self._ssh_config_path, self._refresh_interval)
        yield Footer()
